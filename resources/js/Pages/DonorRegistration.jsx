            ...
            <form className="mx-52 mt-10 mb-10 sm:max-xl:mb-10 sm:max-xl:mx-0" onSubmit={submit}>
                ...
                <div className='flex flex-row justify-between'>
                    <div className="mb-6 w-full mr-2">
                        ...
                        <input type="date" id="date" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.50y-600r-gray-400-blue-500er-blue-500" placeholder="" required value={data.appointment_date} onChange={e => setData('appointment_date', e.target.value)} />
                    </div>
                    <div className="mb-6 w-full mr-2">
                        <label htmlFor="time" className="block mb-2 text-sm font-medium text-gray-900"></label>
                        <input type="time" id="time" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.50y-600r-gray-400-blue-500er-blue-500" placeholder="" required value={data.appointment_time} onChange={e => setData('appointment_time', e.target.value)} />
                    </div>
                </div>
                <div className="mb-6">
