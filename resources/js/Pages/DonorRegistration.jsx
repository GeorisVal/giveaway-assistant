...
export default function DonorRegister(props) {
    return (
        ...
        <main>
            <form className="mx-52 mt-10 mb-10 sm:max-xl:mb-10 sm:max-xl:mx-0">
                <div className="mb-6">
                    <label for="username" className="block mb-2 text-sm font-medium text-gray-900">Nookazon Username</label>
                    <input type="text" id="username" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.50y-600r-gray-400-blue-500er-blue-500" placeholder="Username"></input>
                </div>
                <div className="mb-6">
