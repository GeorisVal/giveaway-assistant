    ...
    return (
        <tr className={checkbox ? "bg-[#fffbab] border-b leading-tight" : "bg-white border-b leading-tight"}>
            ...
            <td className="px-6 truncate ...">
                <input type="date" min={today} className={props.schedule_date ? "py-1 border-[#e5e5e5]" : "text-red-500 border-[#FED3CD] py-1"} defaultValue={props.schedule_date} onChange={handleDateChange}/>
            ...
            <td className="pl-6 truncate ...">
                <form id={"note" + props.id} onSubmit={handleNoteSubmit} className="flex flex-row">
                    <input type="text" defaultValue={props.notes} className="leading-3 border-[#e5e5e5] py-1" onChange={e => setNote(e.target.value)} onFocus={() => setVisibleButton(true)} onBlur={() => setVisibleButton(false)}/>
